...
use ethers::{
    prelude::*,
    types::{
        transaction::eip2718::TypedTransaction, Address, Bytes, H256, Transaction, TransactionRequest, U256,
    },
...
fn decode_swap_operation(tx: &Transaction, to: &Address) -> Option<SwapOperation> {
